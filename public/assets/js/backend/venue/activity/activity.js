define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'venue/activity/activity/index' + location.search,
                    add_url: 'venue/activity/activity/add',
                    edit_url: 'venue/activity/activity/edit',
                    del_url: 'venue/activity/activity/del',
                    multi_url: 'venue/activity/activity/multi',
                    import_url: 'venue/activity/activity/import',
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'enrollrange', title: __('Enrollrange'), operate: 'LIKE'},
        ...
        recyclebin: function () {
            ...
            // 初始化表格
            table.bootstrapTable({
                url: 'venue/activity/activity/recyclebin' + location.search,
                pk: 'id',
                sortName: 'id',
                columns: [
                    [
                            ...
                            buttons: [
                                {
                                    ...
                                    url: 'venue/activity/activity/restore',
                                    refresh: true
                                },
                                {
                                    name: 'Destroy',
                                    ...
                                    icon: 'fa fa-times',
                                    url: 'venue/activity/activity/destroy',
                                    refresh: true
                                }
                            ],
